...
//  }
  ...
  Future saveData()async{
    saveBoolSP("HasFeverPOD5", _q1Value);
    saveBoolSP("HasWoundRedOrDischargePOD5", _q2Value);
    saveBoolSP("HasCalfTenderPOD5", _q3Value);
    saveBoolSP("HasSOBPOD5", _q4Value);
    saveBoolSP("HasDysuriaRetenPOD5", _q5Value);
    saveBoolSP("HasNumbnessPOD5", _q6Value);
