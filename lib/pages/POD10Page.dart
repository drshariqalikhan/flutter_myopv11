...
class POD10 extends StatefulWidget {

  @override
  _POD10State createState() => new _POD10State();
}

class _POD10State extends State<POD10> {
...
//  }
  ...
  Future saveData()async{
    saveBoolSP("HasFeverPOD10", _q1Value);
    saveBoolSP("HasWoundRedOrDischargePOD10", _q2Value);
    saveBoolSP("HasCalfTenderPOD10", _q3Value);
    saveBoolSP("HasSOBPOD10", _q4Value);
    saveBoolSP("HasDysuriaRetenPOD10", _q5Value);
    saveBoolSP("HasNumbnessPOD10", _q6Value);
